CREATE SCHEMA IF NOT EXISTS "vt_saas";
...
--> statement-breakpoint
ALTER TABLE "vt_saas"."vercel_messages" ADD CONSTRAINT "vercel_messages_conversation_id_vercel_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "vt_saas"."vercel_conversations"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
CREATE INDEX "idx_threads_user_id" ON "vt_saas"."threads" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_threads_conversation_id" ON "vt_saas"."threads" USING btree ("conversation_id");--> statement-breakpoint
...
CREATE INDEX "idx_vercel_messages_created_at" ON "vt_saas"."vercel_messages" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "idx_memory_jobs_created_at" ON "vt_saas"."memory_extraction_jobs" USING btree ("created_at");
