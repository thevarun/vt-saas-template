      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <article className={cn('prose prose-neutral max-w-none', marketingDark && 'prose-invert')}>
          ...
          <p>
            ...
            processor. By subscribing, you authorize us to charge the applicable
            fees to your chosen payment method until you cancel. Fees are
            non-refundable except where required by law. We may change pricing
            with reasonable notice; changes apply to the next billing cycle. You
            can cancel at any time, and access continues until the end of the
            current paid period.
          </p>
          ...
          <p>
            ...
            transmit unlawful, infringing, or harmful content. We may suspend or
            restrict access to protect the service and its users.
          </p>
          ...
          <p>
            ...
            submit and grant us a limited license to host and process it solely
          ...
          <p>
            ...
            or consequential damages, and our aggregate liability is limited to
            the amounts you paid us in the twelve months preceding the claim.
          </p>
          ...
          <p>
            ...
            {governingLaw}
            , without
            regard to its conflict-of-laws rules. Any disputes will be resolved
            in the courts located there, unless otherwise required by applicable
            law.
          </p>
