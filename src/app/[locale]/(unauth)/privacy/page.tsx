      ...
      <section className="relative overflow-hidden pb-20 pt-28 sm:pt-32">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <article className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p>
              We collect only the data we need to provide and improve the
              service, and we are transparent about how it is used. We do not
              sell your personal data. Where required, we process data under a
              lawful basis such as consent, contract, or legitimate interest.
            </p>

            <h2 id="data-we-collect">2. Data we collect</h2>
            <p>
              We collect account data you provide (such as your email and
              profile details), authentication identifiers, billing information
              handled by our payment processor, and product-usage and diagnostic
              data generated as you interact with the service.
            </p>
            ...
            <p>
              ...
              provider (including optional OAuth sign-in), a payment processor,
              a transactional email provider, a product-analytics platform, and
              an error-monitoring service. We share only what each provider needs
            ...
            <p>
              ...
              controls, and provider-level safeguards. No system is perfectly
              secure, but we work to protect your information and to notify you of
              incidents where required by law.
            </p>
