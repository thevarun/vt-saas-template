...
/**
 * Empty States Showcase Page
 * Displays all EmptyState component variants for design consistency verification
 */
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3">
          <div className="flex size-10 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900">
            <Inbox className="size-5 text-blue-600 dark:text-blue-400" />
          </div>
          <div>
