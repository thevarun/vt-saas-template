...
// Official GitHub mark. lucide-react v1 removed all brand icons (incl. Github),
// so the logo is inlined here instead of imported. `fill="currentColor"` so the
// `text-*` utility on the className controls its color.
...
// Official Google multi-color icon (per brand guidelines)
    ...
    <div className="grid grid-cols-2 gap-3">
      ...
      >
        {loading
          ...
          : (
              <GitHubIcon className="mr-2 size-4 shrink-0 text-slate-900" />
            )}
        {t('github')}
      </button>
    </div>
